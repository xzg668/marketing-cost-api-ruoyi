...
public class TechnicalDataSalaryController {
  ...
  @GetMapping
  public CommonResult<TechnicalDataSalaryResponse> get(@PathVariable Long productId) {
    return execute(() -> applicationService.get(productId, actorProvider.current()));
  }

  @PreAuthorize(READ_PERMISSION)
  @GetMapping("/references")
  public CommonResult<TechnicalDataSalaryReferenceResponse> references(
  ...
  public CommonResult<TechnicalDataSalaryResponse> applyReference(
      @PathVariable Long productId,
      @RequestBody TechnicalDataSalaryReferenceRequest request) {
  ...
  public CommonResult<TechnicalDataSalaryResponse> delete(
      @PathVariable Long productId,
