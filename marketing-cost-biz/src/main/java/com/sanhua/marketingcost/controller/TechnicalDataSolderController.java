...
import com.sanhua.marketingcost.service.technicaldata.TechnicalDataSolderApplicationService;
...
@RestController
@RequestMapping("/api/v2/technical-data/products/{productId}/solder")
public class TechnicalDataSolderController {
  ...
  private final TechnicalDataSolderApplicationService applicationService;
  private final TechnicalDataActorProvider actorProvider;

  public TechnicalDataSolderController(
      TechnicalDataSolderApplicationService applicationService,
  ...
  @GetMapping
  public CommonResult<TechnicalDataSolderResponse> get(@PathVariable Long productId,
  ...
  public CommonResult<java.util.List<TechnicalDataSolderSource.Reference>> references(
  ...
  @PreAuthorize(READ_PERMISSION)
  @GetMapping("/material")
  public CommonResult<TechnicalDataSolderSource.MaterialLookup> material(
      @PathVariable Long productId, @RequestParam String materialNo) {
    return execute(() -> applicationService.material(productId, materialNo, actorProvider.current()));
  }

  @PreAuthorize(EDIT_PERMISSION)
  @PutMapping
  public CommonResult<TechnicalDataSolderResponse> save(
      @PathVariable Long productId,
      @RequestBody TechnicalDataSolderSaveRequest request) {
