...
public class FormalU9BomGateway implements LiveU9BomGateway {
  ...
  @Override
  public CurrentU9BomResult readLive(QuoteBomReadContext context) {
    if (context == null) {
  ...
  private boolean existsOnlyInOtherOrganization(QuoteBomReadContext context) {
    Long count =
