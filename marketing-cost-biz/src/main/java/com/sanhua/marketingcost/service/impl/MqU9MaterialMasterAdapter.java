...
@Service
public class MqU9MaterialMasterAdapter implements U9MaterialMasterIngestAdapter {

  @Override
  public U9MaterialMasterSourceType sourceType() {
    return U9MaterialMasterSourceType.MQ;
  }

  @Override
  public U9MaterialImportResponse ingest(U9MaterialMasterIngestRequest request) {
    throw new UnsupportedOperationException("U9 料品主档 MQ 接入尚未实现，请继续使用 Excel 导入");
  }
}
