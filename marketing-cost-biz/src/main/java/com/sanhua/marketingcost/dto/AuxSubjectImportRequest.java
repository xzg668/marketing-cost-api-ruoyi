...
public class AuxSubjectImportRequest {
  private List<AuxSubjectRow> rows;

  public List<AuxSubjectRow> getRows() {
    return rows;
  }

  public void setRows(List<AuxSubjectRow> rows) {
    this.rows = rows;
  }

  public static class AuxSubjectRow {
