...
public class BomManualItemImportRequest {
  private List<BomManualItemRow> rows;

  public List<BomManualItemRow> getRows() {
    return rows;
  }

  public void setRows(List<BomManualItemRow> rows) {
    this.rows = rows;
  }

  public static class BomManualItemRow {
