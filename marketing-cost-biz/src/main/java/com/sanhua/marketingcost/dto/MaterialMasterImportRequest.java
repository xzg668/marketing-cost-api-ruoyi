...
public class MaterialMasterImportRequest {
  private List<MaterialMasterRow> rows;

  public List<MaterialMasterRow> getRows() {
    return rows;
  }

  public void setRows(List<MaterialMasterRow> rows) {
    this.rows = rows;
  }

  public static class MaterialMasterRow {
