...
public class PriceLinkedItemImportRequest {
  private String pricingMonth;
  private List<PriceLinkedItemImportRow> rows;
  ...
  public List<PriceLinkedItemImportRow> getRows() {
    return rows;
  }

  public void setRows(List<PriceLinkedItemImportRow> rows) {
    this.rows = rows;
  }

  public static class PriceLinkedItemImportRow {
    private String pricingMonth;
