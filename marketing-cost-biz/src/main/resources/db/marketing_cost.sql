...
CREATE TABLE `lp_material_price_type` (
  ...
  `bill_no` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '旧导入单据号，Excel价格类型-导入无此列',
  `material_code` varchar(64) COLLATE utf8mb3_bin NOT NULL,
  `material_name` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL,
  `material_spec` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL,
  `material_model` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL,
  `unit` varchar(32) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '单位',
  `material_shape` varchar(32) COLLATE utf8mb3_bin DEFAULT NULL,
  `category_code` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '主分类编码',
  `category_name` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '主分类名称',
  `price_type` varchar(32) COLLATE utf8mb3_bin NOT NULL,
  `period` char(7) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '价格期间；为空表示全局价格类型路由',
  `source` varchar(32) COLLATE utf8mb3_bin DEFAULT 'import',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_mpt_excel_route` (`material_code`,`material_model`,`material_shape`,`price_type`,`period`)
...
CREATE TABLE `lp_price_fixed_item` (
  ...
  `material_name` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL,
  `material_code` varchar(64) COLLATE utf8mb3_bin NOT NULL,
  `business_unit_type` varchar(20) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '业务单元',
  ...
  `fixed_price` decimal(18,6) DEFAULT NULL COMMENT '固定价实际取价单价；结算固定价备注行允许为空',
  ...
  `source_type` varchar(32) COLLATE utf8mb3_bin NOT NULL DEFAULT 'PURCHASE' COMMENT '来源类型：PURCHASE/PURCHASE_FIXED/SETTLE/SETTLE_FIXED',
  `process_no` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '采购流程编号',
  `planned_price` decimal(18,6) DEFAULT NULL COMMENT '计划价（结算固定价专用）',
  `markup_ratio` decimal(10,6) DEFAULT NULL COMMENT '上浮比例（结算固定价专用）',
  `remark` varchar(512) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '备注',
  `pricing_month` varchar(7) COLLATE utf8mb3_bin NOT NULL DEFAULT '2026-03' COMMENT '结算期间 YYYY-MM',
  `base_settle_price` decimal(18,6) DEFAULT NULL COMMENT '结算固定价专用：基准结算价，仅追溯不取价',
  `linked_settle_price` decimal(18,6) DEFAULT NULL COMMENT '结算固定价专用：联动结算价，仅追溯不取价',
  `source_system` varchar(32) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '来源系统：OA/SRM/U9/EXCEL/MANUAL',
  `source_sheet_name` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '来源 Excel sheet 名',
  `source_row_no` int DEFAULT NULL COMMENT '来源 Excel 原始行号',
  `source_batch_no` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '导入批次号',
  `import_file_name` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '导入文件名',
  `imported_by` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '导入人',
  `imported_at` datetime DEFAULT NULL COMMENT '导入时间',
  `external_row_id` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '外部行 id；固定采购价非 U9 按此字段幂等',
  `process_status` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '固定采购价流程状态',
  `srm_doc_no` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT 'SRM 单据编号',
  `material_category` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '固定采购价物料类别',
  `tax_rate` decimal(10,6) DEFAULT NULL COMMENT '税率',
  `original_process_fee` decimal(18,6) DEFAULT NULL COMMENT '原不含税加工费',
  `original_process_fee_tax_included` decimal(18,6) DEFAULT NULL COMMENT '原含税加工费',
  `original_tax_excluded_price` decimal(18,6) DEFAULT NULL COMMENT '原不含税价格',
  `original_tax_included_price` decimal(18,6) DEFAULT NULL COMMENT '原含税价格',
  `original_supplier_name` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '原供方名称',
  `current_process_fee` decimal(18,6) DEFAULT NULL COMMENT '现不含税加工费',
  `current_process_fee_tax_included` decimal(18,6) DEFAULT NULL COMMENT '现含税加工费',
  `current_tax_excluded_price` decimal(18,6) DEFAULT NULL COMMENT '现不含税价格；固定采购价主价格来源',
  `current_tax_included_price` decimal(18,6) DEFAULT NULL COMMENT '现含税价格',
  `current_supplier_name` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '现供方名称',
  `change_amount` decimal(18,6) DEFAULT NULL COMMENT '上涨额',
  `change_rate` decimal(18,6) DEFAULT NULL COMMENT '幅度',
  `execution_period_text` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '执行日期原始文本',
  `annual_usage_text` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '预计年用量原始文本',
  `applicant` varchar(64) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '申请人',
  `apply_dept` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '申请部门',
  `market_situation` text COLLATE utf8mb3_bin COMMENT '市场行情',
  `similar_compare` text COLLATE utf8mb3_bin COMMENT '类似物比较',
  `approval_conclusion` text COLLATE utf8mb3_bin COMMENT '结论',
  `approval_type` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '审批表类型',
  `business_division` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '涉及事业部',
  `general_manager_approved_at` datetime DEFAULT NULL COMMENT '总经理批准时间',
  `tracking_date` date DEFAULT NULL COMMENT '板分法跟踪日期',
  `print_flag` varchar(32) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '是否打印',
  `settle_reference_header` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '结算固定价最后一列表头',
  `settle_reference_text` varchar(128) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '结算固定价最后一列非数字备注，例如“不用提供”',
  `settle_reference_price` decimal(18,6) DEFAULT NULL COMMENT '结算固定价最后一列数字价格',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_fixed_material` (`material_code`),
  KEY `idx_fixed_supplier` (`supplier_code`),
  KEY `idx_price_fixed_but` (`business_unit_type`),
  KEY `idx_fixed_source_external` (`source_type`,`source_system`,`external_row_id`),
  KEY `idx_fixed_source_material` (`source_type`,`source_system`,`material_code`),
  KEY `idx_fixed_import_batch` (`source_batch_no`)
