...
CREATE TABLE IF NOT EXISTS lp_quote_bom_status (
  ...
  bom_status VARCHAR(32) NOT NULL DEFAULT 'NOT_CHECKED' COMMENT 'NOT_CHECKED/SYNCED/NO_BOM/ENTRY_PENDING/ENTRY_IN_PROGRESS/MANUAL_ENTERED/EXPIRED/CHECK_FAILED',
