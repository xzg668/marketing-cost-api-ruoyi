...
class BomStructureFingerprintServiceTest {

  private final BomStructureFingerprintService fingerprints = new BomStructureFingerprintService();
  ...
  private QuoteBomReadContext context(String month, String org) {
